...
public class VocabTermAutoCompleteIndexerSQL extends Indexer  {   
	...
	public void index() throws Exception {    
		...
		logger.info("Getting all distinct vocab terms & synonyms that are not obsolete and in vocabularies (GO,Mammalian Phenotype,Human Phenotype Ontology,Disease Ontology)");
		String query = "select distinct t.term_key, t.term,t.vocab_name,t.display_vocab_name,t.primary_id, "+
				...
				"t.vocab_name in ('GO','Mammalian Phenotype','Human Phenotype Ontology', 'Disease Ontology', 'Cell Ontology') and "+
